# Income Classification from Census Data

## Data
The training dataset consists of approximately 38,000 data points, with each datapoint having 13 features
Once the training is completed, use the test file to predict the income class 
...
- `census.csv` - Data to be used for training purpose 
- `census_predict.csv` - Data to be used for prediction
